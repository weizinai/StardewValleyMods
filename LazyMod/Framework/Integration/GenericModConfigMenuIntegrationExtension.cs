...
{
    private static readonly string[] BuffMaintainAllowValues =
    {
        "Combat",
        "Farming",
        "Fishing",
    ...
    public static GenericModConfigMenuIntegration<ModConfig> AddLazyModConfig(this GenericModConfigMenuIntegration<ModConfig> configMenu)
    {
        configMenu
            .AddKeybindList(
        ...
        AddFarmingPage(configMenu);
        AddAnimalPage(configMenu);
        AddMiningPage(configMenu);
        AddForagingPage(configMenu);
        AddFishingPage(configMenu);
        AddFoodPage(configMenu);
        AddOtherPage(configMenu);
        AddTreeSettingsPage(configMenu);
    ...
    private static void AddFarmingPage(GenericModConfigMenuIntegration<ModConfig> menu)
    {
        menu.AddPage("Farming", I18n.Config_FarmingPage_Name)
            // 自动耕地
    ...
    private static void AddAnimalPage(GenericModConfigMenuIntegration<ModConfig> menu)
    {
        menu.AddPage("Animal", I18n.Config_AnimalPage_Name)
            // 自动抚摸动物
    ...
    private static void AddMiningPage(GenericModConfigMenuIntegration<ModConfig> menu)
    {
        menu.AddPage("Mining", I18n.Config_MiningPage_Name)
            // 自动清理石头
    ...
    private static void AddForagingPage(GenericModConfigMenuIntegration<ModConfig> menu)
    {
        menu.AddPage("Foraging", I18n.Config_ForagingPage_Name)
            // 自动觅食
    ...
    private static void AddFishingPage(GenericModConfigMenuIntegration<ModConfig> menu)
    {
        menu.AddPage("Fishing", I18n.Config_FishingPage_Name)
            // 自动抓取宝箱物品
            .AddBoolOption(
    ...
    private static void AddFoodPage(GenericModConfigMenuIntegration<ModConfig> menu)
    {
        menu.AddPage("Food", I18n.Config_FoodPage_Name)
            // 自动吃食物-体力
            ...
            .AddTextOption(
                ...
                I18n.Config_FoodBuffMaintain_Tooltip, BuffMaintainAllowValues,
            ...
            .AddTextOption(
                ...
                I18n.Config_DrinkBuffMaintain_ToolTip, BuffMaintainAllowValues,
                GetStringFromBuffType
            )
            .AddTextOption(
    ...
    private static void AddOtherPage(GenericModConfigMenuIntegration<ModConfig> menu)
    {
        menu.AddPage("Other", I18n.Config_OtherPage_Name)
            // 磁力范围增加
    ...
    private static void AddTreeSettingsPage(GenericModConfigMenuIntegration<ModConfig> menu)
    {
    ...
    private static BuffType GetBuffType(string name)
    {
