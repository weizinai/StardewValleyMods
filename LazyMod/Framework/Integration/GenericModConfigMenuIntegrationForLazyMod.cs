...
internal class GenericModConfigMenuIntegrationForLazyMod : IGenericModConfigMenuIntegrationFor<ModConfig>
{
    ...
    public void Register(GenericModConfigMenuIntegration<ModConfig> configMenu)
    {
        ...
        this.AddFarmingPage(configMenu);
        this.AddAnimalPage(configMenu);
        this.AddMiningPage(configMenu);
        this.AddForagingPage(configMenu);
        this.AddFishingPage(configMenu);
        this.AddFoodPage(configMenu);
        this.AddOtherPage(configMenu);
        this.AddTreeSettingsPage(configMenu);
    }

    private void AddFarmingPage(GenericModConfigMenuIntegration<ModConfig> menu)
    {
    ...
    private void AddAnimalPage(GenericModConfigMenuIntegration<ModConfig> menu)
    {
    ...
    private void AddMiningPage(GenericModConfigMenuIntegration<ModConfig> menu)
    {
    ...
    private void AddForagingPage(GenericModConfigMenuIntegration<ModConfig> menu)
    {
    ...
    private void AddFishingPage(GenericModConfigMenuIntegration<ModConfig> menu)
    {
    ...
    private void AddFoodPage(GenericModConfigMenuIntegration<ModConfig> menu)
    {
    ...
    private void AddOtherPage(GenericModConfigMenuIntegration<ModConfig> menu)
    {
    ...
    private void AddTreeSettingsPage(GenericModConfigMenuIntegration<ModConfig> menu)
    {
