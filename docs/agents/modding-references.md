...
### 1. 游戏本体反编译源码 — `D:\Projects\C#\StardewValleyModsReference\StardewValley\StardewValley`
...
### 2. SMAPI 源码与文档 — `D:\Projects\C#\StardewValleyModsReference\SMAPI`
...
- 文档：`docs/README.md`（总索引，含 "For modders" 一节）。
