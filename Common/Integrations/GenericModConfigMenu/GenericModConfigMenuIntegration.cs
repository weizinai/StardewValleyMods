...
internal class GenericModConfigMenuIntegration<TConfig> where TConfig : new()
{
    ...
    public GenericModConfigMenuIntegration(IModRegistry modRegistry, IManifest consumerManifest, Action reset, Action save)
    {
    ...
    public GenericModConfigMenuIntegration<TConfig> AddBoolOption(Func<bool> getValue, Action<bool> setValue, Func<string> name, Func<string>? tooltip = null)
    {
        configMenu?.AddBoolOption(consumerManifest, getValue, setValue, name, tooltip);
        return this;
    }
    ...
    public GenericModConfigMenuIntegration<TConfig> AddNumberOption(Func<int> getValue, Action<int> setValue, Func<string> name,
        Func<string>? tooltip = null, int? min = null, int? max = null, int? interval = null, Func<int, string>? formatValue = null)
    {
        configMenu?.AddNumberOption(consumerManifest, getValue, setValue, name, tooltip, min, max, interval, formatValue);
        return this;
    }
    ...
    /// <param name="interval">The interval of values that can be selected.</param>
    /// <param name="formatValue">Get the display text to show for a value, or <c>null</c> to show the number as-is.</param>
    public GenericModConfigMenuIntegration<TConfig> AddNumberOption(Func<float> getValue, Action<float> setValue, Func<string> name,
    ...
    public GenericModConfigMenuIntegration<TConfig> AddTextOption(Func<string> getValue, Action<string> setValue, Func<string> name, Func<string>? tooltip = null,
        string[]? allowedValues = null, Func<string, string>? formatAllowedValue = null)
    {
        configMenu?.AddTextOption(consumerManifest, getValue, setValue, name, tooltip, allowedValues, formatAllowedValue);
        return this;
    }
    ...
    /// <param name="name">The label text to show in the form.</param>
    /// <param name="tooltip">The tooltip text shown when the cursor hovers on the field, or <c>null</c> to disable the tooltip.</param>
    public GenericModConfigMenuIntegration<TConfig> AddKeybindList(Func<KeybindList> getValue, Action<KeybindList> setValue, Func<string> name, Func<string> tooltip)
    {
        configMenu?.AddKeybindList(consumerManifest, getValue, setValue, name, tooltip);
        return this;
    }
    ...
    {
        configMenu?.AddPageLink(consumerManifest, pageId, text);
        return this;
    }
}