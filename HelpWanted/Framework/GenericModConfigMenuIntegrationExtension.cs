...
{
    public static GenericModConfigMenuIntegration<ModConfig> AddHelpWantedConfig(this GenericModConfigMenuIntegration<ModConfig> configMenu)
    {
        configMenu
            .AddBoolOption(
        ...
        AddVanillaConfigPage(configMenu);
        AddRSVConfigPage(configMenu);
        AddAppearancePage(configMenu);
    ...
    private static void AddVanillaConfigPage(GenericModConfigMenuIntegration<ModConfig> configMenu)
    {
        configMenu
            // 一般设置
    ...
    private static void AddRSVConfigPage(GenericModConfigMenuIntegration<ModConfig> configMenu)
    {
        configMenu
    ...
    private static void AddAppearancePage(GenericModConfigMenuIntegration<ModConfig> configMenu)
    {
        // 外观
        configMenu
