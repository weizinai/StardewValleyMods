...
internal class RSVQuestBoard : BaseQuestBoard
{
    ...
    public RSVQuestBoard()
    {
        // 背景逻辑
        this.billboardTexture = Game1.temporaryContent.Load<Texture2D>("LooseSprites/RSVQuestBoard");
    ...
    public override void draw(SpriteBatch spriteBatch)
    {
        ...
        // 绘制面板纹理
        spriteBatch.Draw(this.billboardTexture, new Vector2(this.xPositionOnScreen, this.yPositionOnScreen), new Rectangle(0, 0, 338, 424), Color.White,
    ...
    private void InitQuestNotes()
    {
        ...
        QuestNotes.Clear();
        // 遍历所有的任务数据,创建任务选项
        var questList = QuestManager.RSVQuestList;
        ...
        QuestManager.RSVQuestList.Clear();
    }
}