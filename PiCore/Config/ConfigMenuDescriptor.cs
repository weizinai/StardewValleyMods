...
public sealed class ConfigMenuDescriptor<TConfig> where TConfig : class, new()
{
    ...
    /// <summary>新增一个页面，此后的选项都归入该页，直到再次切换页面。</summary>
    ...
    /// <summary>在当前位置添加一个跳转到指定页面的链接。</summary>
    ...
    /// <summary>绑定一个布尔成员作为开关选项。</summary>
    ...
    /// <summary>添加一个由布尔开关领头的分区：开关的标签同时充当分区标题，只需声明一次。若开关所在分区还有后续选项，可在本调用后继续链式添加。</summary>
    ...
    /// <summary>绑定一个整数成员作为数值选项。</summary>
    ...
    /// <summary>绑定一个浮点成员作为数值选项。</summary>
    /// <param name="member">成员访问表达式。</param>
    /// <param name="name">选项标签。</param>
    /// <param name="tooltip">悬停提示，或 <c>null</c> 以禁用。</param>
    /// <param name="min">允许的最小值，或 <c>null</c> 不限制。</param>
    ...
    /// <summary>绑定一个字符串成员作为文本选项。可通过 <paramref name="allowedValues" /> 限定可选值，做成下拉列表。</summary>
    /// <param name="member">成员访问表达式。</param>
    /// <param name="name">选项标签。</param>
    /// <param name="tooltip">悬停提示，或 <c>null</c> 以禁用。</param>
    ...
    /// <summary>绑定一个枚举成员，以文本选项的形式呈现，值用成员名映射，显示文本可本地化。</summary>
    ...
    /// <summary>绑定一个 <see cref="KeybindList" /> 成员作为按键绑定列表选项。</summary>
    /// <param name="member">成员访问表达式。</param>
    /// <param name="name">选项标签。</param>
    /// <param name="tooltip">悬停提示，或 <c>null</c> 以禁用。</param>
    /// <param name="enable">是否添加该选项。</param>
    ...
    /// <summary>以“子配置作分区”的方式绑定一个嵌套配置对象：先按 <paramref name="title" /> 输出分区标题，再用 <paramref name="configure" /> 声明该子配置的成员选项，作为可复用的子配置渲染单元。</summary>
    ...
    /// <summary>逃生舱：直接拿到原始 GMCM 集成对象，自行添加模块未内置的复杂选项。适用于成长阶段字典页、动态 allowedValues 列表、列表字符串编辑等长尾场景。</summary>
